...
Creation.create(nom:'Gorillas', creation_type: "Newsletters et t-shirts"    ,description: 'zfezefzefzefzefzefzefzefze', photos: 'gorillas2.jpg', date:'2021-2023', logiciel:'InDesign, Illustrator', poste_occupe: 'Warehouse Supervisor', entreprise: 'Gorillas')

Creation.create(nom:'Plug & Play', creation_type: "Catalogues produits"   ,description: 'efzfedzefezafzefzefze', photos: 'plug2.jpg', date:'2015 et 2019', logiciel:'Photoshop, Indesign', poste_occupe: 'Infographiste', entreprise: 'Auto-entrepreneur')
...
Creation.create(nom:'FotoBorne', creation_type: "Support de communication"   ,description: 'efzfzefzefzefzfeezfezf', photos: 'fotoborne2.jpg', date:'2015 à 2020', logiciel:'Photoshop, InDesign', poste_occupe: 'Infographiste', entreprise: 'Fotoborne Animation')
